...
const spanishTranslations: any = {
  banner: {
    ...
    subtitle:
      "Ubicación estratégica para logística, distribución y última milla en la CDMX",
    description:
      "Presentamos uno de los desarrollos industriales más atractivos en Tlalnepantla: una nave de distribución Clase A estratégicamente ubicada en el altamente demandado submercado Tlalnepantla, epicentro de logística, e-commerce, transporte y entregas de última milla para la Ciudad de México y toda el Área Metropolitana.",
  ...
  warehouseFeatures: {
    ...
    subtitle:
      "La propiedad cuenta con especificaciones constructivas que permiten una operación eficiente, segura y flexible, ideal para e-commerce, centros de distribución, mensajería, paquetería y logística de última milla",
    features: [
      {
  ...
  locations: {
    ...
    description:
      "Ubicada en Tlalnepantla, Estado de México, esta nave industrial se encuentra dentro de uno de los corredores logísticos más consolidados de la Zona Metropolitana de la Ciudad de éxico. Su conectividad inmediata con Periférico Norte, Gustavo Baz, Av. Presidente Juárez y López Portillo la convierte en una opción ideal para operaciones que requieren tiempos de entrega eficientes y cobertura total de la CDMX y Zona Metropolitana",
    addresses: [
      {
  ...
  specifications: {
    ...
    subtitle:
      "Características constructivas de clase mundial para una eficiencia operativa excepcional",
    tabs: [
      {
        id: "building",
    ...
    industries: [
      {
        ...
        description:
          "Ideal para logística urbana y operaciones de última milla",
      },
      {
        id: "retail",
        name: "Centros de distribución",
        description:
          "Distribución centralizada y centros de cadena de suministro",
      },
      {
        id: "automotive",
        name: "Última milla",
  ...
  availability: {
    status: "INMEDIATO",
    statusText:
      "Cronograma perfecto para la planeación operativa y la adecuación del espacio",
  ...
  leadForm: {
    ...
    fields: [
      ...
      {
        name: "warehouseSize",
        label: "Requerimientos de superficie",
        type: "text",
        required: false,
      },
      {
        ...
        type: "select",
        options: ["Tlalnepantla", "Jilotepec", "Ambos"],
        required: false,
      },
      { name: "budget", label: "Presupuesto", type: "text", required: false },
      {
        name: "leaseDuration",
        label: "Duración del contrato de renta",
        type: "text",
        required: false,
      },
      {
  ...
  disclaimer:
    "Este documento ha sido preparado únicamente con fines informativos generales. No se otorgan garantías ni se realizan declaraciones de ningún tipo, ya sean expresas o implícitas, con respecto a la información contenida en el presente documento, incluyendo, entre otras, su contenido, exactitud o confiabilidad. Cualquier parte interesada deberá llevar a cabo su propia investigación y verificación independiente de la información. Se excluyen expresamente todos los términos, condiciones y garantías inferidas o implícitas que pudieran derivarse de este documento, así como cualquier responsabilidad por pérdidas o daños que pudieran surgir de su uso. La información contenida en el presente documento está sujeta a cambios sin previo aviso.",
};
...
const uiTranslations: Record<string, Record<string, string>> = {
  en: {
    ...
    "form.invalidPhoneDigits":
      "Please match the requested format (only digits)",
    "form.success":
  ...
  es: {
    "locationComparison.title":
      "Una solución estratégica para crecer en la CDMX",
    "locationComparison.subtitle":
      "Esta nave combina ubicación, infraestructura y flexibilidad, ofreciendo una plataforma ideal para empresas que buscan eficiencia operativa dentro del principal mercado de consumo del país",
    ...
    "gallery.subtitle":
      "Explora nuestras instalaciones de vanguardia a través de la galería de fotos y videos. Conoce la calidad y características que hacen que nuestros espacios sean ideales para tus operaciones.",
    "availability.title": "Disponibilidad y Precios",
    "availability.subtitle":
      "Listo para ocupar de inmediato. Opciones de precios flexibles según tus necesidades.",
    ...
    "cta.subtitle":
      "Explora nuestras naves industriales Clase A y descubre cómo podemos apoyar tus operaciones.",
    "contact.title": "Contáctenos",
    "contact.subtitle":
      "Elige el método de contacto que prefieras. Estamos aquí para ayudarte a encontrar la solución de almacén perfecta.",
    "contact.whatsapp": "WhatsApp",
    ...
    "form.invalidPhoneLength":
      "El número debe tener entre 9 y 12 dígitos (solo dígitos)",
    "form.invalidPhoneDigits": "Solo dígitos válidos, no letras (solo dígitos)",
    "form.success":
      "✅ ¡Gracias! Hemos recibido su consulta y nos pondremos en contacto con usted pronto.",
  ...
  return useMemo(() => {
    if (language === "es") {
      ...
      return {
        ...
        warehouseFeatures: {
          ...warehouseConfig.warehouseFeatures,
          ...spanishTranslations.warehouseFeatures,
        },
        locations: {
          ...warehouseConfig.locations,
          ...spanishTranslations.locations,
        },
        specifications: {
          ...warehouseConfig.specifications,
          ...spanishTranslations.specifications,
        },
        targetIndustries: {
          ...warehouseConfig.targetIndustries,
          ...spanishTranslations.targetIndustries,
        },
        availability: {
          ...warehouseConfig.availability,
          ...spanishTranslations.availability,
        },
        ctas: { ...warehouseConfig.ctas, ...spanishTranslations.ctas },
        leadForm: {
          ...warehouseConfig.leadForm,
          ...spanishTranslations.leadForm,
        },
